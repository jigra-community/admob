...
class BannerExecutor: NSObject, GADBannerViewDelegate {
    ...
    func showBanner(_ call: JIGPluginCall, _ request: GADRequest, _ adUnitID: String) {
    ...
    func hideBanner(_ call: JIGPluginCall) {
    ...
    func resumeBanner(_ call: JIGPluginCall) {
        if let rootViewController = plugin?.getRootVC() {
            if let subView = rootViewController.view.viewWithTag(2743243288699) {
    ...
    func removeBanner(_ call: JIGPluginCall) {

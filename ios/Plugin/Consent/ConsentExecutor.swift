...
class ConsentExecutor: NSObject {
    ...
    func requestConsentInfo(_ call: JIGPluginCall, _ debugGeography: Int, _ testDeviceIdentifiers: [String], _ tagForUnderAgeOfConsent: Bool) {
    ...
    func showConsentForm(_ call: JIGPluginCall) {
    ...
    func resetConsentInfo(_ call: JIGPluginCall) {
